    ...
    public Class<?> classForName( String name )
    {
        ...
        if ( c == null && baseLoader != null ) {
            try {
                 ...
                 * was looking for foo.
                 *
                 * If the error is NoClassDefFoundError with a "wrong name" message
                 * then just fall through.  Rethrow for all other flavours of this error.
                 */
        ...
        if ( c == null )
            try {
                ...
                /*
                 * see the above explanation of "wrong name" error
                 */
                if (!nce.getMessage().contains("wrong name"))
                    throw nce;
            }
